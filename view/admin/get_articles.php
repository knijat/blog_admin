            ...
            <tbody>';
                ...
                foreach($data['data'] as $datas):
                    ...
                    <tr>
                        ...
                        <td><?= $datas['view'] ; ?></td>
                        <td><?= $datas['date'] ; ?></td>
                        <td><?= $published=($datas['publish']) ? '<a href="http://localhost/admin_panel/?admin=admin/get_articles/publish/0/'.$datas['id_article'].'"><button type="button" class="btn btn-success btn-sm">Yes</button></a>':'<a href="http://localhost/admin_panel/?admin=admin/get_articles/publish/1/'.$datas['id_article'].'"><button type="button" class="btn btn-danger btn-sm">No</button></a>'; ?></td>
